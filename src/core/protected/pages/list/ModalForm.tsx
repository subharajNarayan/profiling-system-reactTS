...
import { postUserRegisterAction } from '../../../../store/modules/userRegister/postUserRegister';
...
const ModalForm = (props:Props) => {
  ...
  const {
    ...
    onSubmit: async(values, { resetForm }) => {
      ...
      setIsLoader(true);
      try {
        res = await props.postUserRegisterAction({
          ...values,
        })
...
const mapStateToProps = (state: RootState) => ({
  loading: state.getUserLogs.postUserRegister.data
})
...
export default connector(ModalForm);