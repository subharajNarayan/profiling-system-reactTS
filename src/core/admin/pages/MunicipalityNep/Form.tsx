...
import { MUNICIPALITY_TYPES_OPTIONS } from '../../../../constants/constants';
          ...
          <div className="col-lg-6">
            ...
            <div className="form-group ">
              ...
              <select
                ...
                onChange={(e) => {
                  handleChange(e);
                  setFieldValue('munici_type', e.target.value); // Update the value in Formik
                }}
                onBlur={handleBlur}
              >
                <option value="selected">--नगरपालिका चयन गर्नुहोस्--</option>
